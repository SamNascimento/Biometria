...
public class EditarFuncionarioTableModel extends AbstractTableModel {

	private static final long serialVersionUID = 1620918827787136402L;
	
	private List<FuncionarioModel> funcionarios;
	private String[] colunas = new String[] { "Id Funcionario", "Nome", "CPF", "Nivel de acesso" };

	/** Creates a new instance of DevmediaTableModel */
	    public EditarFuncionarioTableModel(List<FuncionarioModel> funcionario) {
	        this.funcionarios = funcionario;
	    }

	public EditarFuncionarioTableModel(){
	...
	public void setValueAt(FuncionarioModel aValue, int rowIndex) {
		...
		funcionario.setIdFuncionario(aValue.getIdFuncionario());
		funcionario.setNome(aValue.getNome());
		funcionario.setCpf(aValue.getCpf());
		funcionario.setNivelAcesso(aValue.getNivelAcesso());
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			funcionario.setIdFuncionario(Integer.parseInt(aValue.toString()));
		case 1:
			funcionario.setNome(aValue.toString());
		case 2: 
			funcionario.setCpf(aValue.toString());
		case 3:
			funcionario.setNivelAcesso(Integer.parseInt(aValue.toString()));
		default:
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			valueObject = String.valueOf(funcionarioSelecionado.getIdFuncionario());
			break;
		case 1:
		...
		case 2: 
			...
			break;
		case 3:
			valueObject = String.valueOf(funcionarioSelecionado.getNivelAcesso());
			break;
		default:
